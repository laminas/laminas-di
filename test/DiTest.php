...
//    }
    ...
    protected function configureNoneCircularDependencyTests()
    {
        ...
        $di->instanceManager()->addAlias('YB', 'LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YA'));
        $di->instanceManager()->addAlias('YC', 'LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YB'));
    ...
    public function testCircularDependencyDetectedInAliases()
    {
        ...
        $di->instanceManager()->addAlias('YA', 'LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YC'));
        $di->instanceManager()->addAlias('YB', 'LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YA'));
        $di->instanceManager()->addAlias('YC', 'LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YB'));
    ...
    public function testCircularDependencyDetectedInMixtureOfAliasesAndClasses()
    {
        ...
        $di->instanceManager()->addAlias(
            'YA',
            'LaminasTest\Di\TestAsset\CircularClasses\Y',
            array('y' => 'LaminasTest\Di\TestAsset\CircularClasses\Y')
        );
        ...
        $y = $di->get('LaminasTest\Di\TestAsset\CircularClasses\Y', array('y' => 'YA'));
    }
    ...
    public function testNewInstanceWillThrowAnClassNotFoundExceptionWhenClassIsAnInterface()
    {
        $definitionArray = array (
            'LaminasTest\Di\TestAsset\ConstructorInjection\D' => array(
                'supertypes' => array(),
                ...
                'parameters' => array(
                    '__construct' =>
                    array (
                        'LaminasTest\Di\TestAsset\ConstructorInjection\D::__construct:0' => array(
                            0 => 'd',
            ...
            'LaminasTest\Di\TestAsset\DummyInterface' => array(
                'supertypes' => array(),
                'instantiator' => NULL,
                'methods' => array(),
                'parameters' => array(),
    ...
    public function testGetInstanceWithParamsHasSameNameAsDependencyParam()
    {
        $config = new Config(array(
            'definition' => array(
                'class' => array(
                    'LaminasTest\Di\TestAsset\AggregateClasses\AggregateItems' => array(
                        'addItem' => array(
                            'item' => array('type'=>'LaminasTest\Di\TestAsset\AggregateClasses\ItemInterface',
                                            'required'=>true)
                        )
                    )
                )
            ...
            'instance' => array(
                ...
                'LaminasTest\Di\TestAsset\AggregatedParamClass' => array(
                    'parameters' => array(

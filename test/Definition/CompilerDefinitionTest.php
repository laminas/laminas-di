...
class CompilerDefinitionTest extends TestCase
{
    public function testCompilerCompilesAgainstConstructorInjectionAssets()
    {
        ...
        $this->assertEquals(
            ['LaminasTest\Di\TestAsset\CompilerClasses\C::setB:0' => ['b', 'LaminasTest\Di\TestAsset\CompilerClasses\B', true, null]],
    ...
    public function testHasMethodParameters()
    {
        ...
        $this->assertTrue($definition->hasMethodParameters('LaminasTest\Di\TestAsset\ConstructorInjection\B', '__construct'));
        // setter injection
        $this->assertTrue($definition->hasMethodParameters('LaminasTest\Di\TestAsset\SetterInjection\B', 'setA'));
        // setter injection with method from derived class
        $this->assertTrue($definition->hasMethodParameters('LaminasTest\Di\TestAsset\CompilerClasses\D', 'setB'));
        // class does not exist
        $this->assertFalse($definition->hasMethodParameters('LaminasTest\Di\TestAsset\ConstructorInjection\BB', '__construct'));
        // method not existing
        $this->assertFalse($definition->hasMethodParameters('LaminasTest\Di\TestAsset\SetterInjection\B', 'setB'));
        // method exists but has no parameters
        $this->assertFalse($definition->hasMethodParameters('LaminasTest\Di\TestAsset\SetterInjection\StaticSetter', 'setFoo'));
    }
}

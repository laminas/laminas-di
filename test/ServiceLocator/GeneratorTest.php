...
class GeneratorTest extends TestCase
{
    ...
    public function createDefinitions()
    {
        ...
        $data = [
            'instance' => [
                ...
                'LaminasTest\Di\TestAsset\InspectedClass' => [ 'parameters' => [
                    'baz' => 'BAZ',
                ]],
                'LaminasTest\Di\TestAsset\Struct' => [ 'parameters' => [
                    'param1' => 'foo',
                ]],
            ],
        ];
    ...
    public function testNullAsOnlyArgumentResultsInEmptyParameterList()
    {
        ...
        $cfg = new Config([
            'instance' => [
                'alias' => ['optional' => 'LaminasTest\Di\TestAsset\OptionalArg'],
            ],
            'properties' => [
                'LaminasTest\Di\TestAsset\OptionalArg' => ['param' => null],
            ],
        ]);
    ...
    public function testNullAsLastArgumentsResultsInTruncatedParameterList()
    {
        ...
        $dummy->setName('LaminasTest\Di\TestAsset\DummyParams')
              ->setInstantiator(['LaminasTest\Di\TestAsset\StaticFactory', 'factory']);
        ...
        $cfg = new Config([
            'instance' => [
                ...
                'properties' => [
                    ...
                    'LaminasTest\Di\TestAsset\StaticFactory' => [
                        'params' => null,
                    ],
                ],
            ],
    ...
    public function testNullArgumentsResultInEmptyMethodParameterList()
    {
        ...
        $cfg = new Config([
            ...
            'properties' => [
                'LaminasTest\Di\TestAsset\OptionalArg' => [
                    'param'  => null,
                    'param1' => null,
                    'param2' => null,
                ],

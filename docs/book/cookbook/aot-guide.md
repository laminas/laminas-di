...
requires laminas-code. We will install that component as a development dependency.

Now add laminas-di and laminas-code with composer:
...
> __Note:__ Please make sure that laminas-di version 3.x is installed. When you are
